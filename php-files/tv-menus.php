...
$pdf->setSourceFile('../pdfs/01_Pandan2022.pdf');
...
createPage($pdf, array(18.25, 29.25), 3.88, 45, $dessert - 1, $dessert);
createPage($pdf, array(18.25, 33.2), 3.88, 45, $dessert - 1, $dessert);
...
$pdf->Output('F', '../pdfs/generated.pdf');
